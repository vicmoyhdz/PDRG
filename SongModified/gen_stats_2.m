...
[rup] = gen_stats_inp_2(rup);

rup.p1.mu =  [rup.stats(rup.stats_id,1) rup.user_stats.mean_Vr rup.user_stats.mean_Vmax];
rup.p1.sig =  [rup.stats(rup.stats_id,4) rup.user_stats.sigma_Vr rup.user_stats.sigma_Vmax];
